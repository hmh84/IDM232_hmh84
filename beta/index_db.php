    ...
    ?>
            ...
            <div class="card">
                <div class="card-photo-area">
                    <img src="graphics/cards/<?php echo $row['Main IMG']; ?>" alt="Recipe Photo">
                </div>
                <div class="card-content">
                    <div class="card-area-name">
                        <h2 class="card-title"><?php echo $row['Title']; ?></h2>
                        <p  class="card-subtitle"><?php echo $row['Short Subtitle']; ?></p>
                    </div>
                    ...
                    <div class="card-area-stats">
                        <div class="card-span">
                            ...
                            <p  class="card-mins"><?php echo $row['Cook Time']; ?></p>
                        </div>
                        <div class="card-span">
                            <p  class="card-cals-prefix">Calories/Serving</p>
                            <div class="card-span-line2"></div>
                            <p  class="card-cals"><?php echo $row['Cal/Serving']; ?></p>
                        </div>
                    </div>
                    </div>
            </div>
