<?php
    ...
    $query = "INSERT INTO recipes (title, subtitle, description, cook_time, servings, cal_per_serving, protein, main_img, ingredients_img, step_imgs, all_ingredients, all_steps, how_to_name, how_to_desc)
    VALUES ('$title', '$subtitle', '$description', '$cook_time', '$servings', '$cal_per_serving', '$protein', '$main_img', '$ingredients_img', '$step_imgs', '$all_ingredients', '$all_steps', '$how_to_name', '$how_to_desc');";
