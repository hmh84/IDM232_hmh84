            ...
            <div class="filter" closed>
                ...
                <div id="filter-content">
                    ...
                    <div id="filter-actions">
                        <button class="button-style" id="filter-clear">Clear</button>
                        <button class="button-style" id="filter-submit">Go</button>
                    </div>
                </div>
            </div>
        </div>
