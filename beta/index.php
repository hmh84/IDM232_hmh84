    ...
    if(isset($_GET['filter'])){
        ...
        if(!empty($_GET['protein'])) {
            ...
            for ($i = 0; $i < $filter_count; $i++) {
                $sql_suffix = $sql_suffix."OR protein LIKE '".$filter[$i]."' "; #s concatenates all selected filters building the basic SQL statement.
            }

            $filter_query_raw = $sql_prefix.$sql_suffix.');';
            ...
            echo $filter_query;
            // displays what SQL statement is sent to the server.
        }
